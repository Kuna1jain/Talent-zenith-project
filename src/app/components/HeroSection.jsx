    ...
    <div className="flex max-[850px]:flex-col max-[850px]:w-11/12">
      <div className="w-2/3 pt-10 pr-6 max-[850px]:w-full">
        <div className="mb-5">
          ...
          HR Services To Build Your Business
          </h3>
          <h1 className="text-6xl text-white font-bold max-[1150px]:text-5xl max-[950px]:text-4xl max-[850px]:text-5xl max-[425px]:text-4xl max-[375px]:text-3xl">
            Hi, Welcome to{" "}
            <span className="text-[#ff014f] font-bold">Talent Zenith</span>
            <br />
        ...
        >
         Founded in 2023, we’re a dynamic startup with a passion for innovation and a vision to revolutionize business practices in the MENAP region.

Our founding team comprises seasoned executives from top multinational corporations and large-scale national companies, equipped with the skills and experience to tackle even the most complex business challenges.

At Talent Zenith, we’re committed to helping our clients achieve their goals and realize their full potential. Let us help you take your business to new heights
        </p>
      ...
      <div className="w-1/3 pl-6 max-[850px]:w-80 max-[850px]:mx-auto max-[425px]:w-56">
        <div className="relative before:w-full before:h-3/4 before:bg-[#19283b] before:rounded-t-full before:block before:absolute before:bottom-0 before:-z-10">
          <img src="https://talentzenith.com/wp-content/uploads/2023/03/Talent-Zenith-Logo-v2-1-1536x1536.png" alt="" />
        </div>
      </div>
    </div>
  );
